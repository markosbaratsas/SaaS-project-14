...
export default function AnswerQuestionBox() {
    ...
    useEffect(() => {
        let details = {
            method: 'post',
            url: process.env.REACT_APP_DISPLAY_URL + 'get-questions/',
            data: {},
        }
        console.log(details)
        axios(details)
    ...
    const handleSubmit = (e) => {
        ...
        if(answer.questionID === "-1" || answer.questionID === undefined) alert("Please choose a question")
            ...
            let details = {
                method: 'post',
                url: process.env.REACT_APP_MANAGEMENT_URL + 'answer-question/',
    ...
    const handleChange = (e) => {
        ...
        if(name === 'questionID' && value !== "-1") {
            let details = {
                method: 'get',
                url: process.env.REACT_APP_DISPLAY_URL + 'get-question-and-answers/'+value
            }
            axios(details)
                .then( (response) => {
